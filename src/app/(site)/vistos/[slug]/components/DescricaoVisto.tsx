          ...
          <div className='grid max-w-[823px] mx-auto'>
            ...
            {content && (
              <div 
                className="
                  text-foreground
                  [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:mb-8 [&_h1]:mt-12 [&_h1]:leading-tight
                  [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mb-6 [&_h2]:mt-10 [&_h2]:leading-tight
                  [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:mb-4 [&_h3]:mt-8
                  [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:mb-3 [&_h4]:mt-6
                  [&_p]:text-base [&_p]:leading-relaxed [&_p]:mb-5 [&_p]:text-foreground/90
                  [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-6 [&_ul]:mt-4
                  [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:mb-6 [&_ol]:mt-4
                  [&_li]:mb-3 [&_li]:leading-relaxed
                  [&_a]:text-blue-800 [&_a]:font-medium [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-blue-900
                  [&_blockquote]:border-l-4 [&_blockquote]:border-gray-800/50 [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:my-8 [&_blockquote]:text-lg [&_blockquote]:text-foreground/80
                  ...
                  [&_pre]:bg-gray-900 [&_pre]:text-white [&_pre]:p-4 [&_pre]:rounded-lg [&_pre]:overflow-x-auto [&_pre]:my-8
                  [&_strong]:font-bold [&_strong]:text-foreground
                  [&_em]:italic
                  [&_hr]:my-10 [&_hr]:border-gray-800/20
                "
                data-aos="fade-up" 
                data-aos-delay="400" 
