import { YVGallery, YVSection, YVTitle, YVButton, YVText, YVIcon } from "@/components/YV";
          ...
          <div className='md:w-[320px] md:pr-7 xl:pr-20 xl:w-[400px] lg:flex-shrink-0'>
            ...
            <div data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
              <YVText className='mb-2 md:mb-4'>
                {cityDescription || 'Descrição das principais cidades de destino para este país.'}
              </YVText>
            </div>
            {showButton && (
