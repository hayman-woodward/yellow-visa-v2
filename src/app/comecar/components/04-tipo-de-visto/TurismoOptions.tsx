...
export default function TurismoOptions({
  register,
  errors,
  watch,
  setValue,
  ...
  const handleOpcaoSelect = (opcao: string) => {
    ...
    setValue('turismoOpcao', opcao);
  };

  const opcoes = [
    {
      id: 'momentos-inesqueciveis',
      icon: 'baggage-claim',
      title: 'Quero viver momentos inesquecíveis com quem eu amo'
    },
    {
      id: 'explorar-encontrar-amor',
      icon: 'wine',
      title: 'Quero explorar novos lugares, sabores e culturas'
    },
    {
      id: 'respiro-reconectar',
      icon: 'tent-tree',
      title: 'Preciso de um respiro… me reconectar'
    }
  ...
  return (
    <div className="w-full grid grid-cols-1 grid-rows-[1.2fr_1.8fr] lg:grid-cols-[1fr_2fr] lg:grid-rows-1 relative overflow-hidden min-h-screen max-h-[90vh]">
      ...
      <div className="row-start-1 px-0 md:px-0 relative md:overflow-hidden lg:col-start-1 lg:row-start-1 lg:order-1">
        <YVBanner
          src='/imgs/stepper-form/bg-etapa-04-turismo.jpg'
          srcMobile='/imgs/stepper-form/bg-etapa-04-turismo-mobile.jpg'
          alt='Hero Turismo'
      ...
      <div className="row-start-2 bg-gradient-to-br bg-YV-secondary-gradient relative flex items-center lg:col-start-2 lg:col-span-1 lg:row-start-1 lg:h-screen order-1 lg:order-2 px-1 md:pl-[10%] -mt-0 py-8 md:py-0">
