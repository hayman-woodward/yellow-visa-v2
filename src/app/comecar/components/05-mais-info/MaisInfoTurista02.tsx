...
interface MaisInfoTurista02Props {
...
export default function MaisInfoTurista02({
  register,
  errors,
  watch,
  setValue,
  ...
  const opcoes = [
    ...
    },
    {
      id: '3',
      icon: 'user-add',
      title: 'de três a quatro'
    },
    {
      id: '4+',
      icon: 'users',
      title: 'Mais de quatro'
    }
  ];
