...
interface DescricaoConteudoProps {
  excerpt?: string;
  content?: string;
}

export default function DescricaoConteudo({ excerpt, content }: DescricaoConteudoProps) {
  return (
      ...
      <YVSection className='px-6 md:px-4'>
        <div className='max-w-[1248px] mx-auto md:px-8 xl:px-0 '>
          <div className='grid max-w-[823px] mx-auto'>
            {excerpt && (
              <div className='mb-4 md:mb-0' data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
